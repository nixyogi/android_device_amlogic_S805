LOCAL_PATH := device/MBX/R268

TARGET_BOARD_PLATFORM := meson8               # From ro.mediatek.platform, but lowercase value
TARGET_NO_BOOTLOADER := true
TARGET_BOOTLOADER_BOARD_NAME := R268     # From ro.product.board
